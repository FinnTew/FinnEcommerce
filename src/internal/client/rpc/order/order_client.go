...
import (
	"context"
	order "github.com/FinnTew/FinnEcommerce/src/internal/client/kitex_gen/order"

	"github.com/FinnTew/FinnEcommerce/src/internal/client/kitex_gen/order/orderservice"
